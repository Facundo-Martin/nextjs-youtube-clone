...
const DESCRIPTION_GENERATION_SYSTEM_PROMPT = `Your task is to summarize the transcript of a video. Please follow these guidelines:
    ...
    "generate-description",
    {
      ...
      body: {
        ...
        messages: [
          {
            role: "system",
            content: DESCRIPTION_GENERATION_SYSTEM_PROMPT,
          },
          {
            role: "user",
            content: transcript,
